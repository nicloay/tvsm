...
{
    /// <summary>
    ///     Listen user input defined at <see cref="DirectionActions" /> with the same name as in project settings in Input section
    /// </summary>
    public class InputController : MonoBehaviour
    {
        private static readonly InputAction[] DirectionActions = new[]
